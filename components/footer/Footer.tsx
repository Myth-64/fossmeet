						...
						<div className={styles['right']}>
							...
							<div className={styles['social']}>
								...
								<div className={styles['social-icons-wrapper']}>
									<a href='https://telegram.me/foss_meet' target='_blank' rel='noreferrer noopener'>
										<img src='/telegram.svg' alt='Telegram' />
									</a>
									<a href='https://www.instagram.com/fosscellnitc/' target='_blank' rel='noreferrer noopener'>
										<img src='/instagram.svg' alt='Instagram' />
									</a>
									<a href='https://twitter.com/fosscell' target='_blank' rel='noreferrer noopener'>
